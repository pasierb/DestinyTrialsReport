...
var DestinyMedalDefinition = {
  ...
  "medalsActivityCompleteHighestScoreLosing": {
    "statName": "逆に考えよう…",
    "statDescription": "自チームが負けたマッチで最高のスコアを達成する。",
  ...
  "medalsActivityCompleteVictoryRumbleBlowout": {
    "statName": "涙の総和",
    "statDescription": "敵のスコアの合計よりも高いスコアを出してランブルマッチに勝利する。",
  ...
  "medalsActivityCompleteVictoryRumbleLastSecond": {
    "statName": "負けない",
    "statDescription": "残り30秒、または敵のスコアリミットが近い時に500ポイントリードしてランブルマッチに勝利する。",
  ...
  "medalsActivityCompleteVictoryRumbleSuddenDeath": {
    "statName": "ハートブレーカー",
    "statDescription": "延長戦でランブルマッチに勝利する。",
